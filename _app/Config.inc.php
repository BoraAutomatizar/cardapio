...
define('USER', 'boraauto_cardapio');
define('PASS', 'pue[-.{L#H,L');
define('DBSA', 'boraauto_cardapio');

define("EMAIL_MSG","admin@boraautomatizar.com.br"); //Email para recebimento e envio de mensagens
...
define('HOME', 'https://boraautomatizar.com.br/cardapio/');  // SEMPRE COM A BARRA NO FINAL ---- ---- ---- ----
